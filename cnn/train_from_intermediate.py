...
batch_size = 256
num_epoch = 1000
class_weight = {0:1, 1:55} # TODO: Needs calculation

# Data Directory (Training & Test files are pre-saved numpy matrices)
output_dir = "/home/yangzh/Desktop/output_dir/"
train_file = "/data/physionet_data/splits/split_0/train_preprocessed_measured_window_24.npz"
test_file = "/data/physionet_data/splits/split_0/valid_preprocessed_measured_window_24.npz"
model_file = "physionet_cnn.h5"
...
def train_model(model, X_train, y_train, X_test, y_test, batch_size, num_epoch, callbacks, class_weight, model_file):
